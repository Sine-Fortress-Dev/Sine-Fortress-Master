	...
	static void ConfirmDuel( bool bConfirmed, void *pContext )
	{
		...
		if ( bConfirmed && pLocalPlayer && pNotification->m_iRequiredPlayerClass != TF_CLASS_UNDEFINED )
		{
			...
			if ( pNotification->m_iRequiredPlayerClass != iClass )
			{
				...
				case TF_CLASS_SCIENTIST: 		pKeyValues->SetWString(" player_class", g_pVGuiLocalize->Find(" #TF_Class_Name_Scientist" ) ); break;
				case TF_CLASS_RUSHER: 			pKeyValues->SetWString(" player_class", g_pVGuiLocalize->Find(" #TF_Class_Name_Rusher" ) ); break;
				}
...
void CSelectPlayerForDuelDialog::SetSelectedClass( int iClass )
{
	...
	case TF_CLASS_SCIENTIST: 		pClassName = "#TF_Class_Name_Scientist"; break;
	case TF_CLASS_RUSHER: 			pClassName = "#TF_Class_Name_Rusher"; break;
	}
