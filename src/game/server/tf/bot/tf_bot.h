...
#define TFBOT_IGNORE_ENEMY_SCIENTISTS	0x0200
#define TFBOT_IGNORE_ENEMY_RUSHERS		0x0400
#define TFBOT_IGNORE_ENEMY_SENTRY_GUNS	0x0800
#define TFBOT_IGNORE_SCENARIO_GOALS		0x1000
